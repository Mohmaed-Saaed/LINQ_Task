...
public partial class ApplicationDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.BrandId).HasName("PK__brands__5E5A8E279AE77F64");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__categori__D54EE9B45EC3EFBC");
        ...
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__customer__CD65CB8527732C20");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__orders__46596229A5593385");
        ...
        {
            entity.HasKey(e => new { e.OrderId, e.ItemId }).HasName("PK__order_it__837942D464E5F96A");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__products__47027DF55AC6C9F1");
        ...
        {
            entity.HasKey(e => e.StaffId).HasName("PK__staffs__1963DD9C5E65854D");

            entity.ToTable("staffs", "sales");

            entity.HasIndex(e => e.Email, "UQ__staffs__AB6E616494B4F9C9").IsUnique();
        ...
        {
            entity.HasKey(e => new { e.StoreId, e.ProductId }).HasName("PK__stocks__E68284D3D37C2FA1");
        ...
        {
            entity.HasKey(e => e.StoreId).HasName("PK__stores__A2F2A30C9A513413");
